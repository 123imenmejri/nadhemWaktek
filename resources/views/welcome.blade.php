            ...
            <div class="row">
                <div class="col-lg-12 text-center zindex-1">
                    <h1 class="mb-3">Plannifier votre réunion avec<br>
                        NADHEM WAKTEK</h1>
                    <p class="mb-4">'Nadhem Waktek' est une application web qui facilite la planication des réunions ,
                        les utilisateurs peuvent
                        envoyer un lien qui se connecte aux calendriers de chacun à tt moment.</p>
                    <div
                        class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
                        <a href="{{ url('redirect/google') }}" class="btn btn-primary ml-lg-3 primary-shadow">Google
                            Login</a></a>

                        <img class="img-fluid w-100 banner-image" src="images/hero-area/banner-img.png"
                            alt="banner-img">
                    </div>
                </div>
            </div>
    ...
    <section class="section-lg seo">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <div class="seo-image">
                        <img class="img-fluid" src="images/marketing/cal.png">
                    </div>
                </div>
                <div class="col-md-5">
