  ...
  <div class="container">
    <nav class="navbar navbar-expand-lg navbar-light">
      <a class="navbar-brand" href="{{ route('app') }}">
        <br>
        <div><strong>NADHEM <br>WAKTEK</strong></div></a>
        ...
        <div class="row">
            ...
            <div class="col-sm-6 mb-4">
                <div class="rounded bg-white p-4 shadow-primary">
                    ...
                    <h4>Organisation de réunions à distance :</h4>
                    <p>Les réunions virtuelles éliminent le besoin pour l'équipe et les participants d'être physiquement au même endroit pendant la réunion. Pendant la pandémie de covid-19, les réunions à distance sont de plus en plus courantes.</p>
                </div>
            </div>
            <!-- service item -->
            <div class="col-sm-6 mb-4 translate-y-150">
                <div class="rounded bg-white p-4 shadow-primary">
                    ...
                    <h4>Améliorer la fréquentation :</h4>
                    <p>Une page de planification dédiée qui affiche un résumé de toutes les réunions en ligne augmente considérablement la participation. De plus, de nouvelles réunions peuvent être facilement programmées ici.Vous pouvez voir ce qui a été programmé dans le passé et ce qui se prépare dans le futur.</p>
                </div>
            </div>
            <!-- service item -->
            <div class="col-sm-6 mb-4">
            ...
            <div class="col-sm-6 mb-4 translate-y-150">
                <div class="rounded bg-white p-4 shadow-primary">
                    ...
                    <p>Vous n'avez plus besoin de faire phone appels ou envoyer des e-mails pour confirmer l'heure de la réunion avec les participants. Tout ce que vous avez à faire est d'ajouter les participants à la réunion, et ils seront automatiquement invités à confirmer.</p>
                </div>
            </div>
            <!-- service item -->
            <div class="col-sm-6 mb-4">
                <div class="rounded bg-white p-4 shadow-primary">
                    ...
                    <p>organiser une réunion de travail en ligne vous permet de réaliser des économies non négligeables. Non seulement vos collaborateurs ne se déplacent pas, mais vous n’avez plus besoin de louer une salle ni de prévoir des collations..</p>
                </div>
            </div>
            <!-- service item -->
            <div class="col-sm-6 mb-4 translate-y-150">
                <div class="rounded bg-white p-4 shadow-primary">
                    ...
                    <p>vous permet d’effectuer rapidement des sondages sur les disponibilités des participants à la réunion : vous créez l’événement, chacun reçoit son invitation et vote pour les créneaux qu’il souhaite, puis vous déterminez la date qui convient le mieux..</p>
                </div>
            </div>
        </div>
    </div>
